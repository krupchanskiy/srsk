...
const CrmUtils = {
    ...
    STATUSES: ['lead', 'contacted', 'paid', 'ready', 'completed', 'cancelled'],

    // Цвета статусов
    STATUS_COLORS: {
        lead: '#3b82f6',        // синий — новая заявка
        contacted: '#8b5cf6',   // фиолетовый
        paid: '#f59e0b',        // янтарный
