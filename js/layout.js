...
async function loadTranslations(retried = false) {
    ...
    const requiredKeys = ['self_accommodation', 'nav_user_management', 'nav_retreat_prasad', 'purchased', 'nav_residents_list', 'nav_prasad', 'timeline_uncovered_title', 'fin_split_dept', 'fin_refine'];
