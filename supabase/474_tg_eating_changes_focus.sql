...
-- Расписание не меняем (решение ВГ 24.09.2026): раз в час, 09:00–20:00 по Индии (cron eating-changes,
-- '30 3-14 * * *'). К 09:00 завтрак уже идёт, поэтому об изменениях завтрака сегодня сообщений нет.
