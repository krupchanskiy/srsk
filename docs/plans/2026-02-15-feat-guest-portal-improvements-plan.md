...
## Задача 1 — Плашка Telegram: перенести рядом с ником в profile-card ✅ выполнено, выкачено в прод
...
## Задача 2 — Секция "Фото со мной" на главной гостя ✅ выполнено, выкачено в прод
...
## Задача 3 — Отмена отметки на фото в галерее ✅ выполнено, выкачено в прод
...
|--------|-----------|-------------------|-------|
| 1. Telegram в profile-card | Простая | ✅ выполнено | — |
| 2. Секция "Фото со мной" | Простая | ✅ выполнено | — |
| 3. Отмена отметки на фото | Средняя | ✅ выполнено | — |
